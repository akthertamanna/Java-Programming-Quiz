...
import com.javaprogramming.quiz.databinding.ActivityQuizCompleteBinding;
...
public class QuizCompleteActivity extends AppCompatActivity implements View.OnClickListener{
    ...
    private ActivityQuizCompleteBinding binding;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        binding = ActivityQuizCompleteBinding.inflate(getLayoutInflater());
        ...
        context = QuizCompleteActivity.this;
